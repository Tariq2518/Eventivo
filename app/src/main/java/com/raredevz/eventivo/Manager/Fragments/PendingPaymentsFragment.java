 ...
 * Use the {@link PendingPaymentsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PendingPaymentsFragment extends Fragment implements PaymentsAdapter.ItemClickListener{
    ...
    public static PendingPaymentsFragment newInstance(String param1, String param2) {
        ...
        dref.child("Time_Slots").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (bookings.size()>0){
                    ...
                    adapter.setClickListener(PendingPaymentsFragment.this::onItemClick);
