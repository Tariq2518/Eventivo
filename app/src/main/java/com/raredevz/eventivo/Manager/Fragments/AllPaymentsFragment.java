 ...
 * Use the {@link AllPaymentsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AllPaymentsFragment extends Fragment implements PaymentsAdapter.ItemClickListener{
    ...
    public static AllPaymentsFragment newInstance(String param1, String param2) {
        ...
        dref.child("Time_Slots").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (bookings.size()>0){
                    ...
                    adapter.setClickListener(AllPaymentsFragment.this::onItemClick);
