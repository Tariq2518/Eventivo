 ...
 * Use the {@link ApprovedPaymentsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ApprovedPaymentsFragment extends Fragment implements PaymentsAdapter.ItemClickListener{
    ...
    public static ApprovedPaymentsFragment newInstance(String param1, String param2) {
        ApprovedPaymentsFragment fragment = new ApprovedPaymentsFragment();
        ...
        dref.child("Time_Slots").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (bookings.size()>0){
                    ...
                    adapter.setClickListener(ApprovedPaymentsFragment.this::onItemClick);
